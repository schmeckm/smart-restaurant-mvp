    ...
    <div v-if="selectedProduct" class="chat-container">
      ...
      <div class="input-area">
        ...
        <div class="advanced-options">
          // Füge nach difficulty select hinzu:
          <el-select v-model="recipeLanguage" placeholder="Sprache" size="small" style="width: 120px">
...
Möchtest du automatisch starten oder eigene Vorgaben machen?`)
  ...
  try {
    // ... validation code bleibt gleich ...

    saving.value = true

    const recipeData = {
      productId: selectedProduct.value.id,        // ← CHANGED: productId statt product_id
      name: recipe.name,
      description: recipe.description,
      servings: recipe.servings,
      prepTime: recipe.prepTime,                  // ← CHANGED: prepTime statt prep_time
      cookTime: recipe.cookTime,                  // ← CHANGED: cookTime statt cook_time
    ...
    // ✅ CHANGED: Use new AI Recipe action
    await store.dispatch('recipes/saveAIRecipe', recipeData)  // ← ONLY CHANGE NEEDED!
